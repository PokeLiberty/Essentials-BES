class PokemonTrainerCardScene
  ...
  def pbDrawTrainerCardFront
    ...
    starttime=_ISPRINTF("{2:d} {1:s} {3:d}",
    ...
    textPositions=[
       ...
       [_INTL("N° ID"),332,64,0,baseColor,shadowColor],
       ...
       [_INTL("Tiempo"),34,208,0,baseColor,shadowColor],
       [time,302,208,1,baseColor,shadowColor],
       [_INTL("Iniciado"),34,256,0,baseColor,shadowColor],
