...
class Interpreter
  ...
  def command_106
    # Set wait count
    @wait_count = @parameters[0] * getWaitFramerate
    # Continue
    return true
  end
  #-----------------------------------------------------------------------------
  ...
  def command_205
    ...
    $game_map.start_fog_tone_change(@parameters[0], @parameters[1] * getWaitFramerate)
    # Continue
    return true
  end
  #-----------------------------------------------------------------------------
  ...
  def command_206
    ...
    $game_map.start_fog_opacity_change(@parameters[0], @parameters[1] * getWaitFramerate)
    # Continue
    return true
  end
  #-----------------------------------------------------------------------------
  ...
  def command_223
    ...
    $game_screen.start_tone_change(@parameters[0], @parameters[1] * getWaitFramerate)
    # Continue
    return true
  end
  #-----------------------------------------------------------------------------
  ...
  def command_224
    # Start flash
    $game_screen.start_flash(@parameters[0], @parameters[1] * getWaitFramerate)
    # Continue
    return true
  end
  #-----------------------------------------------------------------------------
  ...
  def command_232
    ...
    # Move picture
    $game_screen.pictures[number].move(@parameters[1] * getWaitFramerate, @parameters[2],
       x, y, @parameters[6], @parameters[7], @parameters[8], @parameters[9])
    # Continue
    return true
  end
