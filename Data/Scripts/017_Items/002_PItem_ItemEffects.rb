...
ItemHandlers::BattleUseOnBattler.add(:XATTACK, proc { |item, battler, scene|
  stat_buff_map = {
    getConst(PBItems,:XATTACK)    => [PBStats::ATTACK, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XATTACK2)   => [PBStats::ATTACK, 2],
    getConst(PBItems,:XATTACK3)   => [PBStats::ATTACK, 3],
    getConst(PBItems,:XATTACK6)   => [PBStats::ATTACK, 6],
    getConst(PBItems,:XDEFEND)    => [PBStats::DEFENSE, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XDEFENSE)   => [PBStats::DEFENSE, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XDEFEND2)   => [PBStats::DEFENSE, 2],
    getConst(PBItems,:XDEFENSE2)  => [PBStats::DEFENSE, 2],
    getConst(PBItems,:XDEFEND3)   => [PBStats::DEFENSE, 3],
    getConst(PBItems,:XDEFENSE3)  => [PBStats::DEFENSE, 3],
    getConst(PBItems,:XDEFEND6)   => [PBStats::DEFENSE, 6],
    getConst(PBItems,:XDEFENSE6)  => [PBStats::DEFENSE, 6],
    getConst(PBItems,:XSPECIAL)   => [PBStats::SPATK, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XSPATK)     => [PBStats::SPATK, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XSPECIAL2)  => [PBStats::SPATK, 2],
    getConst(PBItems,:XSPATK2)    => [PBStats::SPATK, 2],
    getConst(PBItems,:XSPECIAL3)  => [PBStats::SPATK, 3],
    getConst(PBItems,:XSPATK3)    => [PBStats::SPATK, 3],
    getConst(PBItems,:XSPECIAL6)  => [PBStats::SPATK, 6],
    getConst(PBItems,:XSPATK6)    => [PBStats::SPATK, 6],
    getConst(PBItems,:XSPDEF)     => [PBStats::SPDEF, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XSPDEF2)    => [PBStats::SPDEF, 2],
    getConst(PBItems,:XSPDEF3)    => [PBStats::SPDEF, 3],
    getConst(PBItems,:XSPDEF6)    => [PBStats::SPDEF, 6],
    getConst(PBItems,:XSPEED)     => [PBStats::SPEED, 1],
    getConst(PBItems,:XSPEED2)    => [PBStats::SPEED, 2],
    getConst(PBItems,:XSPEED3)    => [PBStats::SPEED, 3],
    getConst(PBItems,:XSPEED6)    => [PBStats::SPEED, 6],
    getConst(PBItems,:XACCURACY)  => [PBStats::ACCURACY, (USENEWBATTLEMECHANICS) ? 2 : 1],
    getConst(PBItems,:XACCURACY2) => [PBStats::ACCURACY, 2],
    getConst(PBItems,:XACCURACY3) => [PBStats::ACCURACY, 3],
    getConst(PBItems,:XACCURACY6) => [PBStats::ACCURACY, 6]
  }
